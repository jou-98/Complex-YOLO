...
for file_i in range(6030,6230):
    ...
    lidar_file = utils.TMPDIR + '/training/velodyne/' + test_i + '.bin'
    calib_file = utils.TMPDIR + '/training/calib/' + test_i + '.txt'
    label_file = utils.TMPDIR + '/training/label_2/' + test_i + '.txt'
